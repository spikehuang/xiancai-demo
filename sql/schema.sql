...
('tom','123','张三','13074920475','三舍412',0,UNIX_TIMESTAMP(NOW()),UNIX_TIMESTAMP(NOW())),
...
`thums` VARCHAR(150) NOT NULL COMMENT '商品缩略图',
...
INSERT INTO t_goods (user_id, name, thums, img, price, cat_id, description, create_time, update_time)
VALUES
(7001,'HTC ONE','etc/thums/htcone1525233132.jpg','etc/img/htconehd1525233132.jpg',800,2,'用了2年的HTC ONE，正品行货，当时买的时候花了4000多，外壳稍有磨损，功能一切正常',UNIX_TIMESTAMP(NOW()),UNIX_TIMESTAMP(NOW())),
(7002,'40寸吉他','etc/thums/guitar1525233523.jpg','etc/img/guitarhd1525233523.jpg',150.88,6,'十字军吉他，用了1年不到，适合入门过渡学习，附送一套爱丽丝琴弦、固弦锥、换弦神器',UNIX_TIMESTAMP(NOW()),UNIX_TIMESTAMP(NOW())),
(7003,'Java编程思想','etc/thums/tij1525233802.jpg','etc/img/tijhd1525233802.jpg',35,4,'八成新Java编程思想第四版',UNIX_TIMESTAMP(NOW()),UNIX_TIMESTAMP(NOW()));
